...
ffmpeg -i intro_bg.mp4 -pix_fmt yuv420p -filter_complex "[0:v]drawtext=font='Amethyst':text='$TEXT':fontcolor=black:fontsize=64:x=(w-text_w)/2:y=(h-text_h)/2:alpha='if(lt(t,$(($STARTIN))),0,if(lt(t,$(($STARTIN+$FADEIN))),(t-$(($STARTIN)))/$(($FADEIN)),if(lt(t,$(($SHOWLEN))),1,if(lt(t,$(($STOPAT))),($(($FADEOUT))-(t-$(($SHOWLEN))))/$(($FADEOUT)),0))))'" outro.mp4
```
...
ffmpeg -i intro_bg.mp4 -loop 1 -i CASA_logo.png -filter_complex " [1:v]fade=in:st=$(($STARTIN)):d=$(($FADEIN)):alpha=1,fade=out:st=$(($SHOWLEN)):d=$(($FADEOUT)):alpha=1[logo]; \
  ...
  alpha='if(lt(t,$(($STARTIN))),0,if(lt(t,$(($STARTIN+$FADEIN))),(t-$(($STARTIN)))/$(($FADEIN)),if(lt(t,$(($SHOWLEN))),1,if(lt(t,$(($STOPAT))),($(($FADEOUT))-(t-$(($SHOWLEN))))/$(($FADEOUT)),0))))'" -c:v libx264 -pix_fmt yuv420p  outro.mp4
```
...
### Scripting the Intro Slide

```bash
python intro.py -l 34.11 -t "Python\:\nthe Basics" -o "2.3-Title_Slide.mp4";
python intro.py -l 25.04 -t "Lists" -o "2.4-Title_Slide.mp4";
python intro.py -l 30.08 -t "Iteration" -o "2.5-Title_Slide.mp4";
python intro.py -l 11.25 -t "The Command Line" -o "2.6-Title_Slide.mp4";
python intro.py -l 37.02 -t "Getting to Grips\nwith Git" -o "2.7-Title_Slide.mp4";

python intro.py -l 25.12 -t "Dictionaries" -o "3.1-Title_Slide.mp4";
python intro.py -l 174.12 -t "LOLs\n(no cats)" -o "3.2-Title_Slide.mp4";
#python intro.py -l '00:02:54.120 -t "LOLs\n(no cats)" -o "3.2-Title_Slide.mp4";
python intro.py -l 24.22 -t "From DoLs\nTo Data" -o "3.3-Title_Slide.mp4";
python intro.py -l 68.27 -t "Funky Town" -o "3.4-Title_Slide.mp4";
python intro.py -l 11.22 -t "Pack it Up" -o "3.5-Title_Slide.mp4";

python intro.py -l 36.26 -t "Methods\n(in this madness)" -o "4.1-Title_Slide.mp4";
python intro.py -l 94.14 -t "Making it\nClassy" -o "4.2-Title_Slide.mp4";
python intro.py -l 122.01 -t "Intelligent\nDesign" -o "4.3-Title_Slide.mp4";
python intro.py -l 61.05 -t "When Things\nGo Wrong" -o "4.4-Title_Slide.mp4";

python intro.py -l 35.20 -t "Is Python\n(Ever) Logical?" -o "5.1-Title_Slide.mp4";
python intro.py -l 62.11 -t "Fooled by\nRandomness" -o "5.2-Title_Slide.mp4";
python intro.py -l 221.11 -t "File Under\nWhat a Pain\!" -o "5.3-Title_Slide.mp4";
python intro.py -l 59.17 -t "Hello, Pandas\!" -o "5.4-Title_Slide.mp4";

python intro.py -l 38.05 -t "Computational Mapping" -o "6.1-Title_Slide.mp4";
python intro.py -l 7.29 -t "Time to Make\na Map\!" -o "6.2-Title_Slide.mp4";
python intro.py -l 5.29 -t "Exploratory Data Analysis" -o "6.3-Title_Slide.mp4";
python intro.py -l 11.22 -t "Exploratory (Spatial) Data Analysis" -o "6.4-Title_Slide.mp4";

python intro.py -l 203.05 -t "Note(books)\nto Documents" -o "7.1-Title_Slide.mp4";
python intro.py -l 99.17 -t "Patterns in Text" -o "7.2-Title_Slide.mp4";
python intro.py -l 172.1 -t "Cleaning Text" -o "7.3-Title_Slide.mp4";
python intro.py -l 71.1 -t "Analysing Text" -o "7.4-Title_Slide.mp4";

python intro.py -l 295.17 -t "The Data Space" -o "8.1-Title_Slide.mp4";
python intro.py -l 61.06 -t "Transformation" -o "8.2-Title_Slide.mp4";
python intro.py -l 36.29 -t "Dimensionality" -o "8.3-Title_Slide.mp4";

python intro.py -l 21.29 -t "Linking Data" -o "9.1-Title_Slide.mp4";
python intro.py -l 11.07 -t "Linking (Spatial) Data" -o "9.2-Title_Slide.mp4";
python intro.py -l 17.15 -t "Grouping Data" -o "9.3-Title_Slide.mp4";
python intro.py -l 170.11 -t "Got to see it\nto believe it" -o "9.4-Title_Slide.mp4";

python intro.py -l 77.05 -t "Classification" -o "10.1-Title_Slide.mp4";
python intro.py -l 12.09 -t "Clustering" -o "10.2-Title_Slide.mp4";
python intro.py -l 12.03 -t "Adding Geography" -o "10.3-Title_Slide.mp4";

#python intro.py -l 1 -t "" -o "-Title_Slide.mp4";
#python intro.py -l 1 -t "" -o "-Title_Slide.mp4";
#python intro.py -l 1 -t "" -o "-Title_Slide.mp4";
```

To generate the 'outro':

```bash
python outro.py -o outro.mp4
```

## Generating the Entire Movie
